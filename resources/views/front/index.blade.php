...
<!-- services section end -->
        ...
        <div class="container">
            ...
            <div class="news_section_2">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <img src="{{asset('Users/assets')}}/images/img-6.png" class="image_6" style="width:100%">
    ...
    <div class="blog_section layout_padding">
        <div class="container">
            ...
            <div class="blog_section_2">
                <div class="row">
                    <div class="col-md-6">
                        <img src="{{asset('Users/assets')}}/images/img-7.png" class="image_7" style="width:100%">
                    </div>
                    <div class="col-md-6">
    ...
    <!-- blog section end -->
    <!--  contact newsletter section start -->
    ...
    <div class="contact_section layout_padding">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="map_main"><img src="{{asset('Users/assets')}}/images/map-img.png"></div>
                </div>
            </div>
        </div>
    </div>
